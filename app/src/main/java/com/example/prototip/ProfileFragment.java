...
public class ProfileFragment extends Fragment {
    ...
    TextView textViewVarsta;
    TextView textViewObiectiv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttoneditProfile.setOnClickListener(view1 -> updateData());
    ...
    private void showLogoutDialog(){
        ...
        builder.setPositiveButton("Da", ((dialogInterface, i) -> {
            //Redirectionare pe pagina LogIn
            Intent intent = new Intent(getContext(), LoginActivity.class);
            startActivity(intent);
            getActivity().finish();
        }));
        builder.setNegativeButton("Nu",((dialogInterface, i) -> dialogInterface.dismiss()));
    ...
    private void updateData() {
        ...
        checkUserDataBase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                // Aceasta metoda a fost lasata goala deoarece nu este necesar să gestionăm evenimentele onCancelled.
            }
        });
