...
// Construiți calea către nodul "breakfast" în funcție de timestamp-ul curent
        ...
        DatabaseReference lunchRef = historyMealsRef.child(currentTimestamp).child("lunch");
        ...
        lunchRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot mealSnapshot : snapshot.getChildren()){
                    ...
                    DatabaseReference mealRef = lunchRef.child(mealId);
                    ...
                    mealRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onCancelled(@NonNull DatabaseError error) {
                            Log.e("LunchActivity","Failed to read value", error.toException());
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(LunchActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    private void deleteFoodItem(FoodInfo foodInfo) {
        ...
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference historyMealsRef = usersRef.child(userId).child("HistoryMeals");
        DatabaseReference lunchRef = historyMealsRef.child(getCurrentTimestamp()).child("lunch");
